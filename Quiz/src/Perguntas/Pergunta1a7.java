...
public class Pergunta1a7 {
	...
	public void Pergunta() {
		...
		pergunta[1] = "Quanto tempo a luz do Sol demora para chegar á Terra?";
		pergunta[2] = "Qual o livro mais vendido no mundo depois da Bíblia? ";
		pergunta[3] = "Que cidade brasileira é conhecida por chover todos os dias quase � mesma hora?";
		...
		pergunta[8] = "Quantas pálpebras tém uma coruja?";
		...
		pergunta[14] = "Como é a conjugação do verbo caber na 1.º pessoa do singular do presente do indicativo?";
		...
		pergunta[20] = "Que substáncia é absorvida pelas plantas e expirada por todos os seres vivos?";
		...
		respostaB[19] = "2- Pulmôes e faringe";
		...
		respostaC[19] = "3- Esófago e branquios";
