...
>>>>>>> ab94b3ef6e997e8e7798174cd8f5b8c95c1130f1
...
<<<<<<< HEAD
		pergunta[2] = "Qual o livro mais vendido no mundo depois da B�blia? ";
=======
...
<<<<<<< HEAD
		pergunta[7] = "J�piter e Plut�o s�o os correlatos romanos de quais deuses gregos?";
=======
...
<<<<<<< HEAD
		    ...
		    if (respostaA[u]==respostaCorr[u]) {
		    	System.out.println("Esfinderson diz: C�sar, o aventureiro, sua resposta est� correta, parceiro!");
		        this.setCorreto(this.getCorreto()+1);
		        
		  }
		      else  {
		    	  System.out.println("Esfinderson diz: C�sar, o aventureiro, sua resposta est� errada, parceiro!\n A resposta correta �: "+respostaCorr[u]);
		      }
=======
			this.setR(leia.nextInt());
			if (this.getR() == 1) {
